...
class Medico {
    ...
    public Medico(String nome, String cpf, String telefone, String email, String especialidade) {
        this.nome = nome;
        this.cpf = cpf;
...
class Usuario {
 ...
 class SistemaConsultaMedica {
    ...
    public void cadastrarMedico() {
        ...
        Medico novoMedico = new Medico(nome, cpf, telefone, email, especialidade);
